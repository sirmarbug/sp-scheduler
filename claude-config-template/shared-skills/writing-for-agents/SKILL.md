...
description: "Użyj przy pisaniu lub edycji dokumentów dla agentów w tym repo — nowych/istniejących skilli (SKILL.md) oraz CLAUDE.md/AGENTS.md, w tym plików generowanych przez stacks/*/CLAUDE.snippet.md. Writing documents for agents. Use when creating or editing skills, or modifying AGENTS.md or CLAUDE.md."
---
